...
public class AgentFactory {
	...
	{
		return agent()
				.withConcepts(randomConcepts(numDimensions, initialThreshold))
				.withWeight(weight)
				.withAssertionModel(assertionModel)
				.build();
	}

	private static List<Concept> randomConcepts(final int numDimensions, final double initialThreshold) {
